import {
    FavoritesButtons, FavoritesWrapper, SkeletonAddFavoritesIcon, SkeletonAddFavoritesText,
    SkeletonArticle, SkeletonHeartIcon, SkeletonImage, SkeletonTag, SkeletonTitle, SkeletonUserAvatar, SkeletonUserInfo,
    StyledArticleCard, StyledBottomWrapper,
    StyledCardContent,
    StyledTagsWrapper, UserInfoWrap, UserNameWrap
